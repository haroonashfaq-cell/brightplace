...
**What this is:** content + visibility system for 10 AIR Communities apartment properties. brightplace's AI agents (run from Claude Code CLI) create all content and control site data via one MCP server. Dev team builds the MCP server, CMS database, and site rendering.
